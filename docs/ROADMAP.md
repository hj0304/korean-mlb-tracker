...
- [x] **S4-06** 디자인 v2 — 사용자 와이어프레임 반영: 랜딩을 다크(#07090c)+레드(#e23b2e) 스포티 스타일로 재구현(스타디움 라이트 그라디언트, 마스크 처리한 선수 사진 히어로, Black Han Sans 헤드라인, 최근 경기 마퀴 티커), 앱 전체 토큰을 다크 기본+레드 액센트로 교체, 폰트 스택 Noto Sans KR/Black Han Sans/Bebas Neue/JetBrains Mono
