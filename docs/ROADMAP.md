...
- [ ] **S4-01** 문서 + 리브랜딩 — PRD 비목표 해제·P1.5 기능 추가, ADR-0009, 서비스명 '태극기 펄럭이며' 적용(frontend metadata/OG 이미지/README), CLAUDE.md 스코프 갱신
- [ ] **S4-02** 디자인 리뉴얼 — 랜딩 페이지(네이비 + 태극 실루엣 히어로, 정적) + 메인 페이지 리스타일(상단 내비게이션 바, 웜톤 배경, 카드/필 스타일). 로그인 분기는 S4-03에서
